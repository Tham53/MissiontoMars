...
const crewMember1 = new CrewMember('Rick', 'pilot', 'chemistry');
Rick.printOutName()
...
const addShip = (name, type, ability, crewlength) => {
  const newShip = new Ship(name, type, ability, crewlengt)
  const crewmember = crewmembers.filter(name)
